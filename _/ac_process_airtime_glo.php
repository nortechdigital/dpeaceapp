...
if (preg_match('/^0[789][01][0-9]{8}$/', $msisdn)) {
...
try {
    ...
    $description = "Purchase of GLO-AIRTIME for N$amount";
    $detail = "GLO-AIRTIME";
    ...
    ('$relationId', '$fullname', '$phone_number', '$temp_ref', '$description', '$discount', '$status', '0', 'Airtime Purchase', '$detail', '$cust_discount', '$current_balance', '$new_balance')";
