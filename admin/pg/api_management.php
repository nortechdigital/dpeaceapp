      ...
      <div class="d-flex align-items-center bg-primary text-light px-3 py-2 mb-4">
        ...
        <div class="table-responsive">
          <table class="table table-all" id="apiKeysTable">
            ...
            <tbody>
              <?php
              $query = "SELECT ak.id, u.email, ak.api_key, ak.created_at FROM api_keys ak JOIN users u ON ak.user_id = u.id ORDER BY ak.created_at DESC";
        ...
        <ul class="list-group">
          <li class="list-group-item"><strong>Airtime:</strong> <span class="">https://dpeaceapp.com/api/airtime/</span></li>
          <li class="list-group-item"><strong>Data:</strong> <span class="">https://dpeaceapp.com/api/data/</span></li>
		  <li class="list-group-item"><strong>Smile:</strong> <span class="">https://dpeaceapp.com/api/smile/</span></li>
          <li class="list-group-item"><strong>Swift:</strong> <span class="">https://dpeaceapp.com/api/swift/</span></li>
          <li class="list-group-item"><strong>Electricity:</strong> <span class="">https://dpeaceapp.com/api/electricity/</span></li>
          <li class="list-group-item"><strong>Cable TV:</strong> <span class="">https://dpeaceapp.com/api/cable-tv/</span></li>
