<?php
  ...
  $transactions_query = "SELECT * FROM transactions WHERE status='success' ORDER BY created_at DESC";
...
<div class="row">
  ...
  <h2 class="text-center bg-primary text-light h5 mb-2 py-2">Successful Transactions</h2>
