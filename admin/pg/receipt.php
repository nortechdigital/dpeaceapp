      ...
      <div class="col-lg-6 mx-auto">
        <div class="card mb-3">
          <div class="card-body text-center">
            ...
            <p class="text-center mt-4 h5 text-primary">Thank you for choosing the Peace App!</p>
            <hr>
            <div class="form-group mt-3 text-center d-print-none">
              <button onclick="window.print()" class="btn btn-success btn-block mt-3">Print</button>
              <a href="?page=dashboard" class="btn btn-primary btn-block mt-3">Close</a>
            </div>
          </div>
        </div>
      </div>
