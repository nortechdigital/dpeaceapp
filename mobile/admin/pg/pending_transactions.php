<?php
  ...
  $transactions_query = "SELECT * FROM transactions WHERE status='pending' ORDER BY created_at DESC";
...
<div class="row">
  ...
  <h2 class="text-center bg-primary text-light h5 mb-2 py-2">Pending Transactions</h2>
