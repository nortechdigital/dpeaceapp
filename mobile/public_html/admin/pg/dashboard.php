        ...
        <?php if($_SESSION['role']=='admin'):?>
          <div class="col-lg-3">
              <div class="card mb-3 shadow" style="height:130px">
                ...
                <!-- <?php if($bal_vas2net <= '428000'){
                    // echo "<script>alert('VAS2NETS WALLET BALANCE IS LOW!');</script>";
          ...
          <div class="col-lg-3">
            <div class="card mb-3 shadow" style="height:130px">
                  <a href="" class="card-body bg-light text-dark text-center text-decoration-none stretched-link">
                    ...
                    <!-- <?php if($balance <= '0'){
                        // echo "<script>alert('SMILE WALLET BALANCE IS LOW!');</script>";
          ...
          <div class="col-lg-3 d-none">
            <div class="card mb-3 shadow" style="height:130px">
                  <a href="" class="card-body bg-light text-dark text-center text-decoration-none stretched-link">
                    ...
                    <!-- <?php if($api_balance_mtn <= '0'){
                        // echo "<script>alert('MTN WALLET BALANCE IS LOW!');</script>";
          ...
          <div class="col-lg-3">
            <div class="card mb-3 shadow" style="height:130px">
                <a href="" class="card-body bg-light text-dark text-center text-decoration-none stretched-link">
                    ...
                    <!-- <?php if($api_balance_airtel <= '0'){
                        echo "<script>alert('AIRTEL WALLET BALANCE IS LOW!');</script>";
          ...
          <div class="col-lg-3">
              <div class="card mb-3 shadow" style="height:130px">
                  ...
                  <!-- <?php if($api_balance_glo <= '0'){
                        echo "<script>alert('GLO WALLET BALANCE IS LOW!');</script>";
