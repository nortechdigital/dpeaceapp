            ...
            <div class="accordion" id="settingsAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingElectricity">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSwift" aria-expanded="false" aria-controls="collapseSwift">
                            <img src="../img/icons/lightning-charge.svg" alt="Swift" style="height: 20px; margin-right: 10px;"> Electricity Subscription
                        </button>
                    </h2>
                    <div id="collapseElectricity" class="accordion-collapse collapse" aria-labelledby="headingElectricity" data-bs-parent="#settingsAccordion">
                        <div class="accordion-body">
                            <form method="POST"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg">Discount (%)</div>
                                    <div class="col-lg">
                                        <label for="subscriberDiscountElectricity">Subscriber</label>
                                        <input type="text" id="subscriberDiscountElectricity" name="subscriberDiscountElectricity" class="form-control" value="<?php echo htmlspecialchars($subscriberDiscountSwiftData); ?>">
                                    </div>
                                    <div class="col-lg">
                                        <label for="agentDiscountElectricity">Agent</label>
                                        <input type="text" id="agentDiscountElectricity" name="agentDiscountElectricity" class="form-control" value="<?php echo htmlspecialchars($agentDiscountSwiftData); ?>">
                                    </div>
                                    <div class="col-lg">
                                        <label for="vendorDiscountElectricity">Vendor</label>
                                        <input type="text" id="vendorDiscountElectricity" name="vendorDiscountElectricity" class="form-control" value="<?php echo htmlspecialchars($vendorDiscountSwiftData); ?>">
                                    </div>
                                </div>
                                <hr>
                ...
                <hr>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTV">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTV" aria-expanded="false" aria-controls="collapseSwift">
                            <img src="../img/icons/tv.svg" alt="Swift" style="height: 20px; margin-right: 10px;"> Electricity Subscription
                        </button>
                    </h2>
                    <div id="collapseTV" class="accordion-collapse collapse" aria-labelledby="headingTV" data-bs-parent="#settingsAccordion">
                        <div class="accordion-body">
                            <form method="POST"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg">Discount (%)</div>
                                    <div class="col-lg">
                                        <label for="subscriberDiscountTV">Subscriber</label>
                                        <input type="text" id="subscriberDiscountTV" name="subscriberDiscountTV" class="form-control" value="<?php echo htmlspecialchars($subscriberDiscountSwiftData); ?>">
                                    </div>
                                    <div class="col-lg">
                                        <label for="agentDiscountTV">Agent</label>
                                        <input type="text" id="agentDiscountTV" name="agentDiscountTV" class="form-control" value="<?php echo htmlspecialchars($agentDiscountSwiftData); ?>">
                                    </div>
                                    <div class="col-lg">
                                        <label for="vendorDiscountTV">Vendor</label>
                                        <input type="text" id="vendorDiscountTV" name="vendorDiscountTV" class="form-control" value="<?php echo htmlspecialchars($vendorDiscountSwiftData); ?>">
                                    </div>
                                </div>
                                <hr>
