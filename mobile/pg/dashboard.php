...
<div class="row">
  ...
  <div class="col-lg-10">
    <div class="container py-2">
      ...
      <div class="">
        <p class="h5 text-primary text-center">Enjoy <span class="text-danger h2">7%</span> off your Spectranet subscription! Activate your discount by clicking on the Spectranet page. No wallet funding needed!</p>
      </div>
      <hr>
      <div class="row g-3">
        <div class="col-lg-3">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Special Offer!</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p class="h5">Enjoy <span class="text-danger h2">7%</span> off your Spectranet subscription! <br> Activate your discount by clicking on the Spectranet page.</p>
        <p class="h5">No wallet funding needed!</p>
      </div>
