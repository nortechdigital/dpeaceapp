<?php 
// session_start();
echo $otp = isset($_SESSION['pre_user']['otp']) ? $_SESSION['pre_user']['otp'] : 'no otp found!';
?>
      ...
      <div class="col-lg-5">
        <form action="./_/ac_create_account.php" method="post" class="card shadow-lg">
          <div class="card-body p-4">
            ...
            <!-- OTP Field -->
            <div class="mb-3">
              <input type="text" name="otp_code" id="otp_code" class="form-control" placeholder="Enter OTP" required oninput="checkOtp()">
            </div>
