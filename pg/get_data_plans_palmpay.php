  ...
  <div class="col-lg-10">
    <div class="container py-2">
      ...
      <div class="card shadow p-4">
        ...
        <form id="dataPlanForm" action="./_/ac_process_data_palmpay.php" method="post">
              ...
              <?php foreach ($items['data'] as $plan): ?>
                <option value="<?php echo htmlspecialchars($plan['itemId']); ?>" 
                  ...
                  <?php echo htmlspecialchars($plan['itemName']); ?> 
              	  (<?php echo htmlspecialchars($plan['extInfo']['itemDescription']); ?> - Price: N<?php echo htmlspecialchars($plan['amount'] / 100); ?>)
                </option>
              <?php endforeach; ?>
            </select>
          </div>
          ...
          <div class="form-group mt-3 text-center">
    		<button type="button" class="btn btn-primary w-100 mt-3" id="confirmButton" onclick="prepareConfirmation()">Purchase Bundle</button>
		  </div>
        </form>
      </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#confirmTransaction').click(function() {
        // Disable the modal confirmation button too
    ...
    // Re-enable buttons if modal is closed without confirmation
    $('#confirmationModal').on('hidden.bs.modal', function() {
        $('#confirmButton').prop('disabled', false);
        $('#confirmButton').text('Purchase Bundle');
        $('#confirmTransaction').prop('disabled', false);
        $('#confirmTransaction').text('Confirm');
    });
    ...
    function updateModal() {
    	...
    	$('#plan').val($('#bouquet_code option:selected').text());
