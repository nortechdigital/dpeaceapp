                ...
                <form action="./_/ac_process_swift.php" method="post" id="dataForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="" id="">
                            ...
                            <option value="<?php echo $row['id']; ?>" data-price="<?php echo $row['price']; ?>"><?php echo $row['plan_name']; ?> - <?php echo $row['roll_over']; ?> - &#8358;<?php echo number_format($row['price'], 2); ?> (Validity: <?php echo $row['validity']; ?> - <?php echo $row['time_details']; ?>)</option>
                        <?php endwhile; ?>
                        </select>           
                        ...
                        <input type="hidden" name="hidden_plan_name" id="hidden_plan_name">
                        <script>
                            document.querySelector('select[name]').addEventListener('change', function() {
                                const selectedOption = this.options[this.selectedIndex];
                                const planName = selectedOption.textContent.trim();

                                document.getElementById('hidden_plan_name').value = planName || '';
                            });
                        </script>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-primary" id="modalSubmitButton" onclick="this.disabled = true; this.textContent = 'Processing...'; document.getElementById('dataForm').submit();">OK</button>
