...
$operator_id = test_input($_GET['id']);
$operator_name = test_input($_GET['name']);

require_once './artx/ArtxApiClient.php';
$api = new ArtxApiClient(true, 'dpeaceapp.api.ngn', 'login@DPeaceAdmin1234');
$products = $api->getOperatorProducts($operator_id, '8.1');
    ...
    <div class="container py-2">
      ...
      <?php endif; ?>
        ...
        <?php if ($providerDetails): ?>
            ...
            <form action="./_/ac_process_electricity_artx.php" method="post" id="electricityForm">
        		<input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
        		<input type="hidden" name="operator" id="operator" value="<?= $operator_id ?>">
                ...
                <select name="account_type" id="account_type" class="form-control" required>
                    ...
                    <option value="PREPAID" selected>Prepaid Meter</option>
                </select>
