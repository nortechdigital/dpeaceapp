            ...
            <div class="row py-3">
                <div class="col-md-8 offset-md-2">
                    <div class="card shadow p-4">
                        <h4 class="d-none">Current Balance: <span class="h1 text-primary" id="bala"></span></h4>
                        
                        <hr>
                        <h6>Virtual Account Details</h6>
                        <ul class="list-group">
                                <li class="list-group-item">
                                    <strong>Bank: OPay <br>Account Number: <?= $depositCode ?></strong>
                                    <br>
                                    <strong>Account Name: DPEACELIFE BUSINESS ENTERPRISE-<?= $_SESSION['firstname'] . ' ' . $_SESSION['lastname'] ?></strong>
                                </li>
                        </ul>
                        <hr>
                                    <p class=""><span class="h5 text-danger">Note: </span>Wallet Top-up Fees:
                                            <ul>
                                                <li>Under &#8358;6,300: &#8358;50 flat fee.</li>
                                                <li>&#8358;6,301 and above: 0.8% fee, capped at N300.</li>
                                            </p>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <strong class="h5 text-center">Bank: <span class="text-primary">OPay</span></strong> <br>
                                            <strong class="h5 text-center">Account Number: <span class="text-primary"><?php echo htmlspecialchars($depositCode); ?></span></strong> <br>
                                            <strong class="h5 text-center">Account Name: <span class="text-primary">DPEACELIFE BUSINESS ENTERPRISE-<?php echo htmlspecialchars($_SESSION['firstname'] . ' ' . $_SESSION['lastname']); ?></span></strong>                                            
                                            <hr>
                                            <p class=""><span class="h5 text-danger">Note:</span>Wallet Top-up Fees:
                                            <ul>
                                                <li>Under &#8358;6,300: &#8358;50 flat fee.</li>
